	...
	if(isset($_POST['dangnhap'])) {
		...
		if($taikhoan=='' || $matkhau ==''){
			...
			if($count>0){
				...
				echo '<alert>Tài khoản hoặc mật khẩu sai</alert>';
				$_SESSION['dangnhap'] = 'Đức Điệp';
				$_SESSION['admin_id'] = '1';
				header('Location: dashboard.php');
			}
		}
...
<body>
	...
	<div class="form-group">
		...
		<input type="submit" name="dangnhap" class="btn btn-primary text-center" value="Đăng nhập Admin">
		</form>
	</div>
	</div>
	<div class="col-md-3"></div>
